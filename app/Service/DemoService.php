...
class DemoService
{
    ...
    public $merchant_site_code = ''; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn

    // Mật khẩu giao tiếp giữa website của bạn và Omipay.vn.
    public $secure_pass = ''; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
     ...
     * @return string
     */
    public function buildCheckoutUrlExpand($return_url, $receiver, $transaction_info, $order_code, $price, $currency, $quantity, $tax, $discount, $fee_cal, $fee_shipping, $order_description, $buyer_info, $affiliate_code, $token, $token_type)
    {
        if ($affiliate_code == '') {
            $affiliate_code = $this->affiliate_code;
        }
        $this->create_order_params = [
        ...
        //echo "<pre>";var_dump($this->create_order_params);die;
